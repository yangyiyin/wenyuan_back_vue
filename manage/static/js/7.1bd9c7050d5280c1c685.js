...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        get_info: function get_info() {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_getDataEarth__["_62" /* news_info */])({ id: this.id }).then(function (res) {
                if (res.code == this.$store.state.constant.status_success) {
        ...
        submit: function submit() {
            ...
            this.$confirm('确认无误, 是否继续?', '提示', {
                ...
                this.loading = true;
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_getDataEarth__["_63" /* news_edit */])({ id: this.id, title: this.title, link: this.link, img: this.img, content: this.content }).then(function (res) {
                    if (res.code == this.$store.state.constant.status_success) {
                        this.$message({
                            message: res.msg,
                            type: 'success'
