        ...
        <div class="table_container">
            <el-table
                ...
                <!--<el-table-column label="学生报名" width="450">-->
                    <!--<template slot-scope="scope">-->
                        <!--&lt;!&ndash;<el-button size="mini" @click="handleDaoru(scope.row)">导入</el-button>&ndash;&gt;-->
...
//                categories:[],
        ...
        methods: {
            list() {
                sign_course_list({page:this.currentPage,page_size:this.limit,title:this.title}).then(function(res){
            ...
            goto_edit(id) {
                this.$router.push({path:'sign_course_edit',query:{id:id}});
            },
